...
| Extension Version | 	autocomplete.js                                                  | instantsearch.js |
|-------------------|-------------------------------------------------------------------| --- | --- | --- |
| [v3.11.0](https://github.com/algolia/algoliasearch-magento-2)            | [1.6.3](https://github.com/algolia/autocomplete.js/tree/v1.6.3)   | [4.41.0](https://github.com/algolia/instantsearch.js/tree/v4.41.0) |
